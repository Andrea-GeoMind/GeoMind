...
export const CONTENT_RECOMMENDATIONS: Record<string, ContentRecommendation> = {
  thin_content: {
    ...
    impact:
      "Les IAs favorisent les sources denses en information. Un contenu étoffé augmente considérablement les chances d'être cité dans des réponses détaillées.",
    effort: 'medium',
  },
  no_faq_content: {
    ...
    impact:
      'Les sections FAQ sont parmi les contenus les plus cités par les IAs. Elles correspondent exactement au format question/réponse utilisé par ChatGPT, Perplexity et Gemini.',
    effort: 'low',
  },
  no_structured_lists: {
    ...
    impact:
      "Les listes structurées sont extraites facilement par les IAs pour répondre à des questions du type « quels sont les avantages de… ». Elles augmentent la probabilité d'être cité mot pour mot.",
    effort: 'low',
  },
  no_definition_patterns: {
    ...
    impact:
      'Les IAs extraient fréquemment les définitions pour répondre aux requêtes informationnelles. Un contenu qui définit clairement ses concepts est cité comme source de référence.',
    effort: 'low',
  },
  meta_description_missing: {
    ...
    impact:
      "La meta description est lue par les crawlers IA pour comprendre le sujet d'une page. Son absence réduit la compréhension sémantique de vos contenus.",
    effort: 'low',
  },
  meta_description_too_short: {
    ...
    impact:
      'Une meta description trop courte sous-exploite ce signal sémantique. Les IAs se fient à la densité et à la précision de la description pour évaluer la pertinence de la page.',
    effort: 'low',
  },
  duplicate_meta_descriptions: {
    ...
    impact:
      'Les meta descriptions dupliquées signalent un manque de différenciation sémantique à vos pages. Les IAs peuvent avoir du mal à distinguer vos contenus les uns des autres.',
    effort: 'medium',
  },
  title_missing_or_short: {
    ...
    impact:
      "Le titre est le signal le plus fort pour les IAs afin d'identifier le sujet d'une page. Un titre manquant ou trop court dégrade fortement la qualité de l'indexation.",
    effort: 'low',
  },
  no_dates_in_content: {
    how: "Ajoutez des dates de publication et de mise à jour sur vos articles et pages de contenu. Utilisez les balises schema.org `datePublished` et `dateModified` en plus de l'affichage visible. Mentionnez explicitement les dates dans le corps du texte lorsque c'est pertinent (ex : « Mise à jour en janvier »).",
    impact:
      "Les IAs valorisent les contenus datés car cela leur permet d'évaluer la fraîcheur de l'information. Un contenu non daté est perçu comme potentiellement obsolète.",
    effort: 'low',
  },
  low_page_count: {
    ...
    impact:
      "Un site avec peu de pages a une faible empreinte sémantique. Les IAs ont besoin d'un volume de contenu suffisant pour considérer votre domaine comme une source d'autorité.",
    effort: 'high',
  },
}
