...
| FIX-SLICE-AUDIT | ✅ | 2026-05-27 | Suppression slice(0,5) dans discovery-status route (affichait 5 prompts au lieu de 3), fix full-audit.sh (E2E chromium prod, SIGPIPE), fix vitest.config.ts (exclude .claude/.claire worktrees) — 342 tests verts |
