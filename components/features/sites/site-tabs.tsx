...
import { LayoutDashboard, TrendingUp, ListTodo, Wand2, Swords, Radio, MessageSquareQuote, MapPin, Bot, Shield, Wrench, FileText, BookOpen, Sparkles } from 'lucide-react'
...
const TABS = [
  ...
  { label: 'Agent-Ready',    segment: 'agent-ready', icon: Bot },
